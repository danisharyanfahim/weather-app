...
import { formatCamelCase, formatDate, formatTime } from '../utils/util-functions';
...
import { WiDayHaze, WiDayThunderstorm, WiFog, WiNightAltThunderstorm, WiNightFog } from 'react-icons/wi';
...
const WeatherCard = (props: WeatherCardProps) => {
    ...
    return (
        <div className="weather-card" style={{ '--wind-direction': deg + 'deg' }}>
            ...
            <div id={weatherType.toLowerCase()} className='weather-container'>
                <div className="weather-icon">
                    {selectWeatherIcon(weatherType.toLowerCase())}
                </div>
                <h2>
                    {formatCamelCase(description)}
                </h2>
